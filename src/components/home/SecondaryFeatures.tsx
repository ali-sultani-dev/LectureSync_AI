...
const features = [
  {
    name: 'Record Instantly',
    description:
      'Start recording lectures or meetings with one click. No complicated setup—just hit record and let AI do the rest.',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Automatic Transcripts',
    description:
      'Get full, accurate transcripts generated in real time so you never miss a word from your classes or meetings.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'Smart Summaries',
    description:
      'Let AI break down long lectures and meetings into easy-to-read summaries, capturing all the key points.',
    icon: DeviceClockIcon,
  },
  {
    name: 'Searchable Notes',
    description:
      'Quickly search through all your past lectures and meetings. Find what you need, exactly when you need it.',
    icon: DeviceListIcon,
  },
  {
    name: 'Sync Across Devices',
    description:
      'Access your notes, transcripts, and summaries from any device. Stay organized everywhere you go.',
    icon: DeviceChartIcon,
  },
  {
    name: 'Safe & Secure',
    description:
      'Your recordings and notes are securely stored, keeping your information private and protected.',
    icon: DeviceLockIcon,
  },
]
      ...
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-medium tracking-tight text-gray-900">
            All your lecture and meeting notes—organized by AI.
          </h2>
          <p className="mt-2 text-lg text-gray-600">
            LectureSyncAI makes capturing, organizing, and reviewing lectures and meetings
            effortless. Record, transcribe, summarize, and access everything you need in one place.
          </p>
        </div>
        <ul
          role="list"
